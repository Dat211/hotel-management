						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<form:input type="date" path="checkinDate" id="checkinDate"
									cssClass="form-control" onchange="calculateTotalPrice()" />
						...
						<div class="form-group ">
							...
							<div class="d-flex  align-items-center">
								<form:select id="promotionId" path="promotionId"
									cssClass="form-control" onchange="updateTotalPrice()">
				...
				<c:forEach items="${listRoom}" var="item">
					...
					<div id="room" class="item-room card mb-3 col-md-12">
						...
						<div class="card-body pl-2">
							...
							<div class="dropdown-divider"></div>
							<h6>
								Giá phòng: <span class="text-danger font-weight-bolder">${item.getPrice()}</span>
							</h6>
							<h6>
...
<c:if test="${orderModel.statusId eq 1 || orderModel.statusId eq 6}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Lấy tất cả các phần tử có lớp inputC
        var inputs = document.getElementsByClassName('inputC');
        var inputTotal = document.getElementsByClassName('inputTotal');
