...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Chỉnh sửa nhân viên</h6>
		</div>
		<div class="card-body">
			<div class="">
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
					<div class="column">
						...
						<div class="form-group">
							...
							<div class="col-sm-11">
								<p>
									<input type="radio" name="IsLocked" value="true" checked> Đang làm việc<br>
									<input type="radio" name="IsLocked" value="false"> Nghỉ làm
								</p>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-sm-11">
								<img id="Photo"
									src="<c:url value='/template/web/img/room/avatar/avatar-2.jpg'/>"
